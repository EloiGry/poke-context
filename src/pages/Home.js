  ...
  return (
    <Box>
       <Box border="1px" borderColor="teal" borderRadius={5} p={5}>
        <Box mb={5}>
          <img className="img" src={pokemon.sprites.other["official-artwork"].front_default} alt={pokemon.name} />
        </Box>
        ...
        <UnorderedList>
          {/* {isLogged ? (
            ...
            <Link to="/login"> <Button colorScheme="teal" variant="solid" w="100%" mt={5}> Log in </Button></Link>    
          )} */}
